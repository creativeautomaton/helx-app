...
.controller('AppCtrl', ['$scope', '$ionicSlideBoxDelegate', '$cookieStore', '$cookies', '$filter', '$http', '$location', '$timeout', '$ionicGesture', '$ionicModal', '$ionicPopover', '$state', '$ImageCacheFactory', 'onlineStatus', '$ionicViewSwitcher', function(
...
.controller('DescriptionCtrl', ['$scope', '$ionicPopover', function($scope, $ionicPopover) {
...
.controller('AltCtrl', ['$scope', '$ionicPopover', function($scope, $ionicPopover) {
	// Description Popover Controller
  $ionicPopover.fromTemplateUrl('templates/description.html', {
    scope: $scope,
    animation: 'popIn'
...
.controller('ultrasoundToolCtrl', ['$scope', '$ionicPopover', function($scope, $ionicPopover) {
	// Description Popover Controller
...
.controller('HelxOverviewCtrl', ['$scope', '$ionicModal', '$state', '$ionicSlideBoxDelegate', '$timeout', function($scope, $ionicModal, $state, $ionicSlideBoxDelegate, $timeout) {
...
.controller('FeaturesCtrl', ['$scope', '$ionicPopover', function($scope, $ionicPopover) { }])

.controller('ClinicalImagesCtrl', ['$scope', '$http', '$location', '$timeout', '$ionicModal', function($scope, $http, $location, $timeout, $ionicModal ) {
...
.controller('clinicalModalSlider', ['$scope', function($scope) {
...
.controller('systemCtrl', ['$scope', '$ionicSlideBoxDelegate', '$cookieStore', '$ionicViewSwitcher', '$cookies', '$filter', '$http', '$location', '$timeout', '$ionicModal', '$state', '$interval', function(
    $scope,  $ionicSlideBoxDelegate, $cookieStore,
...
.controller('SlideController', ['$scope', '$ionicSlideBoxDelegate', '$ionicPopover', function($scope,  $ionicSlideBoxDelegate, $ionicPopover) {
...
.controller('DataSlideController', ['$scope', '$ionicModal', '$state', '$ionicSlideBoxDelegate', '$ionicViewSwitcher', function($scope, $ionicModal, $state, $ionicSlideBoxDelegate, $ionicViewSwitcher) {
  // Description HELX Overview Modal Controller
...
.controller( 'HideCtrl', ['$scope', '$state', '$stateParams', function($scope, $state, $stateParams ) {
  $scope.$on('$ionicView.enter', function(e) {
      $scope.hideMenu = true;
...
.run(['$ionicPlatform', '$ImageCacheFactory', '$rootScope', function($ionicPlatform, $ImageCacheFactory, $rootScope) {
